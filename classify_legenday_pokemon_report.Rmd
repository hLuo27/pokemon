...
![Image of Mew](https://raw.githubusercontent.com/hLuo27/pokemon/master/images/mew.png)

```{r}
classify(testing[testing$name=='Mew',])
```

Finally, we apply our function to all the Pokémon in the testing set as follows in the dataframe predicted_testing below.
